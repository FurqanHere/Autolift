...
const HomePage = () => {
  ...
  return (
    <>
          ...
          <div className="col-md-6">
            <div className="homepage-about-text-wrapper">
              <p className="mb-3 homepage-about-paragraph-bold">
                Dedicated to delivering reliable towing solutions with honesty, speed, & professionalism, we ensure every driver receives the care, safety, and support they truly deserve.
              </p>
              <p className="mb-0 homepage-about-paragraph-regular">
                Backed by years of expertise, our committed team offers trustworthy towing, emergency roadside support, & recovery solutions designed to keep drivers safe, secure, & confident on every journey, anytime and anywhere.
              </p>
            </div>
          </div>
        </div>
        <div className="row mt-5">
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="text-center">
              <h3 className="fw-bold mb-2 homepage-about-stat-number">10+</h3>
              <p className="text-secondary mb-0 homepage-about-stat-label">SERVICE COVERAGE</p>
            </div>
          </div>
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="text-center">
              <h3 className="fw-bold mb-2 homepage-about-stat-number">40+</h3>
              <p className="text-secondary mb-0 homepage-about-stat-label">Tow Trucks</p>
            </div>
          </div>
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="text-center">
              <h3 className="fw-bold mb-2 homepage-about-stat-number">15820+</h3>
              <p className="text-secondary mb-0 homepage-about-stat-label">Successful Recoveries</p>
            </div>
          </div>
          <div className="col-md-3 col-sm-6 mb-4">
            <div className="text-center">
              <h3 className="fw-bold mb-2 homepage-about-stat-number">13+</h3>
              <p className="text-secondary mb-0 homepage-about-stat-label">Years</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container my-5 homepage-features-section" id="features">
        <div className="text-center mb-5">
          <h2 className="fw-bold mb-3 homepage-features-heading">Explore Premium Features</h2>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-arrow-repeat fs-1 homepage-features-icon"></i>
              </div>
              <h5 className="fw-bold mb-3">Fully Functional</h5>
              <p className="text-secondary">
                Enjoy a complete suite of features designed for seamless user experiences.
              </p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-chat-dots fs-1 homepage-features-icon"></i>
              </div>
              <h5 className="fw-bold mb-3">Live Chat</h5>
              <p className="text-secondary">
                Connect with your audience in real-time for instant support and engagement.
              </p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-code-slash fs-1 homepage-features-icon"></i>
              </div>
              <h5 className="fw-bold mb-3">Secure Data</h5>
              <p className="text-secondary">
                Protect your information with industry-leading security measures and encryption.
              </p>
            </div>
          </div>
          {/* Row 2 */}
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-geo-alt fs-1 homepage-features-icon"></i>
              </div>
              <h5 className="fw-bold mb-3">Location Tracking</h5>
              <p className="text-secondary">
                Gain insights into user behavior with advanced location tracking capabilities.
              </p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-gear fs-1 homepage-features-icon"></i>
              </div>
              <h5 className="fw-bold mb-3">Powerful Settings</h5>
              <p className="text-secondary">
                Take control with robust settings that allow for personalized app configurations.
              </p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="text-center p-4">
              <div className="mb-3">
                <i className="bi bi-translate fs-1 homepage-features-icon"></i>
              </div>
        ...
        <div className="container homepage-screenshots-container">
          <div className="text-center mb-5">
            ...
            <p className="text-white homepage-screenshots-description">
              Clean and elegant interface with sApp that combines simplicity with beauty, ensuring a smooth and enjoyable user journey.
            </p>
          </div>
      ...
      {/* Download Our App */}
      <div className="container my-5 py-5 homepage-download-section" id="downloadApp">
